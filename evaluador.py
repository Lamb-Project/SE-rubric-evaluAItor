#!/usr/bin/env python3
"""
Sistema de Evaluación Automatizada de Proyectos - Versión Markdown
Utiliza Claude 3 Sonnet para evaluar trabajos según rúbrica
Usa Markdown como formato intermedio para mayor robustez
"""
...
from utils.api_client import APIClient, crear_cliente_api
from utils.report_generator import ReportGenerator

class EvaluadorProyecto:
    """Clase principal para evaluar proyectos usando Claude con Markdown"""
...
- Matrices: {puntuaciones.get('matrices', 0)}/10"""
    ...
    def generar_documento_final(self, informe_sintesis: str, puntuaciones: Dict[str, float]):
        ...
        self.guardar_resultado_md("EVALUACION_FINAL", documento_final)
    ...
    def ejecutar_evaluacion(self):
        ...
        try:
            ...
            self.logger.info("Iniciando proceso de evaluación...")
            ...
            self.logger.info(f"Revise el archivo EVALUACION_FINAL.md en {self.config.directorio_salida}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Sistema de Evaluación Automatizada con Markdown',
...
Ejemplos de uso:
  ...
  %(prog)s documento.md ./resultados --openai gpt-3.5-turbo
    ...
    parser.add_argument('archivo', help='Archivo del documento a evaluar')
    ...
    try:
        ...
        config = EvaluacionConfig(
            archivo_documento=os.path.abspath(args.archivo),
        ...
        print(f"📄 Archivo principal: EVALUACION_FINAL.md")
